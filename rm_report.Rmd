...
_Note_: tables generated in this R Markdown report can be reproduced inside an R environment using the commands preceding each table. However, tables in this report have been formatted for presentation purposes using the datatable::datatable() function. See the raw R Markdown code in `rm_report.Rmd` for details.
